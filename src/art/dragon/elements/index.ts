// The element registry: the seven ElementSpecs in bible order (docs/ART_BIBLE.md section 3). Each element artist owns
...
/** Element ids in bible order: fire, spike, rock, lightning, water, slinkwing, dusk. */
export const ELEMENT_IDS: readonly DragonElement[] = ['fire', 'spike', 'rock', 'lightning', 'water', 'slinkwing', 'dusk'];

/** Every element's spec by id. */
export const ELEMENTS: Readonly<Record<DragonElement, ElementSpec>> = Object.freeze({
  fire: FIRE, spike: SPIKE, rock: ROCK, lightning: LIGHTNING, water: WATER, slinkwing: SLINKWING, dusk: DUSK,
});
