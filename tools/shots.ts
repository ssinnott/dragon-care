...
const pairs: string[] = [
  ...
  // the base (docs/BASE_DESIGN.md): its first seconds (the start camera, and the barn's east half: the seven young
  // adults between them), a minute of care, and every stage at once (the ages preset)
