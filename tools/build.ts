...
// Same shape as game-engine's tools/build.ts: esbuild resolves the './foo.ts' specifiers directly, so
// the graph the dev server serves one file at a time is the one bundled here.
